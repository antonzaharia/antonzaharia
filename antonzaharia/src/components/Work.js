...
export default function Work({ close }) {
    ...
    return (
        <animated.article id="work" style={props}>
			...
			<a className="link-project" href="https://rgadbets.herokuapp.com/">Live Website</a> and <a className="link-project" href="https://github.com/antonzaharia/topz">Github</a> for
			...
			<hr />
			<a className="link-project" href="https://github.com/antonzaharia/Food-Order">Github</a> for
			...
			<hr />
			<a className="link-project" href="https://github.com/antonzaharia/BestSellerBook">Github</a> for
			<p>Best Seller CLI</p>
